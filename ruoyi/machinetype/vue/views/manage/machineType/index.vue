<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="machineTypeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['manage:machineType:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['manage:machineType:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="machineTypeRef" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="机械类别名称" prop="machineTypeName">
...
import { listMachineType, getMachineType, delMachineType, addMachineType, updateMachineType } from "@/api/manage/machineType";
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除机械类别编号为"' + _machineTypeIds + '"的数据项？').then(function() {
...
function handleExport() {
  proxy.download('manage/machineType/export', {
    ...queryParams.value
