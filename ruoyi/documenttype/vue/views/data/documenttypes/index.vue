<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="ID" prop="documentTypeId">
        <el-input
    ...
    <el-table v-loading="loading" :data="documenttypesList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="ID" align="center" prop="documentTypeId" />
      <el-table-column label="文档类型名称" align="center" prop="documentTypeName" />
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['data:documenttypes:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['data:documenttypes:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="documenttypesRef" :model="form" :rules="rules" label-width="80px">
      </el-form>
      <template #footer>
...
import { listDocumenttypes, getDocumenttypes, delDocumenttypes, addDocumenttypes, updateDocumenttypes } from "@/api/data/documenttypes";
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除文档类型编号为"' + _documentTypeIds + '"的数据项？').then(function() {
...
function handleExport() {
  proxy.download('data/documenttypes/export', {
    ...queryParams.value
