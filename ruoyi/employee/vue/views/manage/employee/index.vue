  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="性别" prop="employeeSex">
        <el-select v-model="queryParams.employeeSex" placeholder="请选择性别" clearable>
          <el-option
    ...
    <el-table v-loading="loading" :data="employeeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="员工类型" align="center" prop="employeeType">
        <template #default="scope">
          <dict-tag :options="agri_employee_type" :value="scope.row.employeeType"/>
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['manage:employee:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['manage:employee:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
const { agri_employee_type, sys_user_sex } = proxy.useDict('agri_employee_type', 'sys_user_sex');
...
function handleExport() {
  proxy.download('manage/employee/export', {
    ...queryParams.value
