        ...
        >
          <div class="device-header-area">
            <div class="device-icon">
              <el-image :src="item.icon" fit="contain" class="icon-image">
                <template #error>
                  <el-icon class="icon-placeholder"><Sunny /></el-icon>
                </template>
              </el-image>
            </div>
          ...
          <div class="device-content">
            <div class="device-title">
              <span class="device-name">{{ item.stationName }}</span>
            </div>
              ...
              <div class="info-grid">
                <div class="info-item">
                  ...
                  <div class="info-value">
                    {{ parseTime(item.lastUpdate, "{y}-{m}-{d}") }}
                  </div>
                </div>
                <div class="info-item">
                  <div class="info-label">
                  ...
                  <div class="info-value">{{ item.weatherStationId }}</div>
                </div>
              </div>
...
const handleUpdate = async (row) => {
  ...
  router.push(`/devices/weather-edit/index/${weatherStationId}`);
};
...
const handleView = (row) => {
  selectedDeviceId.value = row.weatherStationId;
